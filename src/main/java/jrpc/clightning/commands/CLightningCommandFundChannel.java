...
class CLightningCommandFundChannel extends AbstractRPCCommand<CLightningBitcoinTx> {

  private static final String COMMAND_NAME = "fundchannel";

  public CLightningCommandFundChannel() {
    super(COMMAND_NAME);
  }
