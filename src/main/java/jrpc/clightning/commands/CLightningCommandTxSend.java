 ...
 */
class CLightningCommandTxSend extends AbstractRPCCommand<CLightningBitcoinTx>{

    private static final String COMMAND_NAME = "txsend";

    public CLightningCommandTxSend() {
        super(COMMAND_NAME);
    }
